import { defineComponent, computed, reactive, toRefs, provide, resolveComponent, resolveDirective, withDirectives, openBlock, createElementBlock, normalizeClass, normalizeStyle, toHandlerKey, createElementVNode, renderSlot, createCommentVNode, createVNode, withCtx, withModifiers, Fragment, renderList, createTextVNode, toDisplayString, createBlock, withKeys, vModelText, resolveDynamicComponent, vShow } from 'vue';
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return withDirectives((openBlock(), createElementBlock("div", {
    ...
    style: normalizeStyle({
      display: _ctx.virtualTriggering ? "inline-block" : void 0,
      width: _ctx.virtualTriggering ? "auto" : void 0
    }),
    [toHandlerKey(_ctx.mouseEnterEventName)]: ($event) => _ctx.states.inputHovering = true,
    onMouseleave: ($event) => _ctx.states.inputHovering = false
  }, [
    _ctx.virtualTriggering ? (openBlock(), createElementBlock("div", {
      key: 0,
      ref: "wrapperRef"
    }, [
      createElementVNode("div", {
        ref: "triggerRef",
        onClick: ($event) => _ctx.dropdownMenuVisible = !_ctx.dropdownMenuVisible
      }, [
    ...
    createVNode(_component_el_tooltip, {
      ...
      _: 3
    }, 8, ["visible", "placement", "teleported", "popper-class", "popper-options", "fallback-placements", "effect", "transition", "persistent", "append-to", "show-arrow", "offset", "virtual-triggering", "virtual-ref", "onBeforeShow", "onHide"])
  ], 16, ["onMouseleave"])), [
