declare const _default: import("vue").DefineComponent<{
    ...
    filteredOptions: import("vue").ComputedRef<import("./select.types").OptionType[]>;
    ...
    deleteTag: (event: MouseEvent, option: import("./select.types").Option) => Promise<void> | undefined;
